    ...
    <section className="relative h-screen overflow-hidden">
      ...
      {HERO_IMAGES.map((img, i) => (
        <motion.img
          key={i}
          src={img}
          alt="Wedding planner Hyderabad luxury wedding decor destination wedding corporate event"
      ...
      <div className="relative z-10 h-full flex items-center justify-center text-center px-4">
        <div>
          ...
          <h1 
            className="font-cinzel font-bold text-3xl md:text-5xl lg:text-6xl text-white tracking-wider mb-4 uppercase drop-shadow-[0_6px_25px_rgba(0,0,0,0.9)]"
            title="Best Wedding Planner in Hyderabad | Event Management Company Hyderabad | Luxury & Destination Weddings"
          >
            Agarwal Events &<br />Wedding Planners in Hyderabad
          </h1>

          <p className="font-cormorant text-xl md:text-2xl text-white/90 mb-2 drop-shadow">
            Luxury Wedding Planner in Hyderabad | Event Management Company | Corporate & Birthday Events
          </p>

          <p className="font-lato text-sm md:text-base text-white/70 tracking-widest mb-8">
            Destination Wedding Planner Hyderabad · Wedding Decor · Mehendi · Haldi · Sangeet · Serving All Over India
          </p>

          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link 
              to="/services"
              title="Explore wedding planning services Hyderabad | corporate events | birthday party planner"
            >
            ...
            <Link 
              to="/book"
              title="Book wedding planner in Hyderabad | event organizer consultation"
            >
