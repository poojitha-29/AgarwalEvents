    ...
    <>
      ...
      >
        <div className="container-custom flex items-center justify-between h-16 md:h-20">
          ...
          <Link 
            to="/" 
            title="Best Wedding Planner in Hyderabad | Event Management Company Hyderabad"
            className="font-cinzel font-bold text-lg md:text-xl text-beige-100 tracking-wider"
          >
            {SITE_NAME}
          </Link>
          ...
          <div className="hidden lg:flex items-center gap-8">
            {NAV_LINKS.map((link) => (
              <Link
                key={link.to}
                to={link.to}
                title={`${link.label} - Wedding Planner in Hyderabad | Event Organizer Hyderabad | Corporate & Birthday Event Planner Hyderabad`}
          ...
          <div className="hidden lg:block">
            <Link
              to="/book"
              title="Book Best Wedding Planner in Hyderabad | Budget Wedding & Event Management Services"
          ...
          <>
            ...
            >
              <div className="flex items-center justify-between p-5 border-b border-maroon-600">
                <span 
                  className="font-cinzel font-bold text-beige-100 text-sm"
                  title="Top Wedding Planner in Hyderabad | Event Management Company"
                >
                  {SITE_NAME}
                </span>
                <button
              ...
              <div className="flex flex-col p-5 gap-1">
                {NAV_LINKS.map((link) => (
                  <Link
                    key={link.to}
                    to={link.to}
                    title={`${link.label} - Wedding planner near me Hyderabad | Event management services`}
                ...
                <Link
                  to="/book"
                  title="Hire Wedding Planner in Hyderabad | Book Event Organizer Now"
