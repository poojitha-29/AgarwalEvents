...
export default function About() {
  ...
  return (
    <PageWrapper>
      ...
      {/* ✅ SEO ONLY (BACKEND KEYWORDS) */}
      <SEO 
        title="About Us"
        description="Best wedding planner in Hyderabad and top event management company offering luxury weddings, destination weddings, corporate events, birthday parties, wedding decor, mehendi, haldi, sangeet, engagement, reception planning, wedding venues, and cultural weddings including Telugu, South Indian, Hindu, Muslim and Christian weddings across Hyderabad and Pune."
        url="https://agarwalevents.com/about" 
      />
      ...
      <section className="relative pt-28 pb-20 bg-maroon-700 overflow-hidden">
        <div className="absolute inset-0 opacity-20">
          <img 
            src={IMAGES.hero} 
            alt="Wedding planner Hyderabad event management company corporate events birthday planner wedding decor"
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <FadeInUp delay={0.2}>
              <div className="relative">
                <img 
                  src={IMAGES.left} 
                  alt="Luxury wedding planner Hyderabad destination wedding decor mandap setup"
                  className="w-60 h-72 rounded-xl shadow-xl object-cover" 
                  loading="lazy" 
                />
                <img 
                  src={IMAGES.right} 
                  alt="Wedding decoration Hyderabad floral decor mandap wedding stage decoration"
                  className="absolute top-12 left-36 w-48 h-60 rounded-xl shadow-xl border-4 border-beige-100 object-cover" 
                  loading="lazy" 
                />
                <img 
                  src={IMAGES.bottom} 
                  alt="Reception event planner Hyderabad engagement ceremony corporate event setup"
                  className="absolute -bottom-6 left-16 w-40 h-52 rounded-xl shadow-xl border-4 border-beige-100 object-cover" 
                  loading="lazy" 
                />
              </div>
            </FadeInUp>
        ...
        <div className="container-custom">
          <FadeInUp>
            <div className="text-center max-w-3xl mx-auto">
              ...
              <p className="font-cormorant text-xl md:text-2xl text-beige-100 leading-relaxed italic">
              ...
              return (
                <FadeInUp key={item.title} delay={i * 0.08}>
                  <motion.div 
                    ...
                    title="Best wedding planner in Hyderabad event management company corporate birthday events wedding decor services"
                  >
